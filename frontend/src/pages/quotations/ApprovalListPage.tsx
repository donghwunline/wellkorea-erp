...
import { Alert, Card, LoadingState, PageHeader, Pagination } from '@/components/ui';
...
export function ApprovalListPage() {
  ...
  // Handle view entity
  const handleViewEntity = useCallback((approval: ApprovalDetails) => {
  ...
  const canActOnApproval = useCallback((approval: ApprovalDetails): boolean => {
    ...
    const currentLevelDecision = levels.find(
      l => l.levelOrder === approval.currentLevel
    );

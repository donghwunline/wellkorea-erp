...
COMMENT ON TABLE customers IS 'External parties receiving quotations and invoices';
COMMENT ON TABLE suppliers IS 'Vendors for purchasing and RFQ workflows';

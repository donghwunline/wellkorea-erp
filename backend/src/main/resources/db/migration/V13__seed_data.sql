-- V12: Consolidated seed data for development and testing
-- Contains all test users, roles, companies, products, projects, quotations, etc.
-- Consolidated from V10 and V12, with company_roles fixed to exclude dropped columns.
...
-- FIXED: company_roles without credit_limit, default_payment_days, notes (removed in V13)
...
-- =====================================================================
-- VENDOR MATERIAL OFFERINGS (from V12)
-- =====================================================================
...
INSERT INTO quotations (id, project_id, version, status, quotation_date, validity_days, total_amount, notes,
                        created_by_id, approval_status, approval_submitted_by_id, approval_submitted_at,
                        approval_completed_at, approval_completed_by_id, created_at, updated_at)
VALUES (1, 1, 1, 'DRAFT', '2025-01-15', 30, 682000.00, '삼성전자 본사 초기 견적', 1,
        'NONE', NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (2, 2, 1, 'PENDING', '2025-01-18', 30, 1255000.00, '현대자동차 조립라인 장비 견적', 2,
        'PENDING', 2, CURRENT_TIMESTAMP, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (3, 3, 1, 'APPROVED', '2025-01-20', 30, 1295000.00, 'LG디스플레이 승인 견적', 4,
        'APPROVED', 4, CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '1 day', 1,

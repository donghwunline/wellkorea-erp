...
import com.wellkorea.backend.core.auth.infrastructure.blacklist.InMemoryTokenBlacklistService;
 ...
 * <ul>
 *     <li>In-memory (development/testing) - {@link InMemoryTokenBlacklistService}</li>

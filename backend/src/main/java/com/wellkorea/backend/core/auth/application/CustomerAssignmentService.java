...
import com.wellkorea.backend.core.auth.domain.CustomerAssignment;
import com.wellkorea.backend.core.auth.infrastructure.persistence.CustomerAssignmentRepository;

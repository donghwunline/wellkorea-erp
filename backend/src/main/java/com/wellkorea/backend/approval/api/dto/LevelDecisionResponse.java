...
/**
 * Response DTO for an approval level decision.
 */
public record LevelDecisionResponse(
        Long id,
        Integer levelOrder,
        String levelName,
    ...
    public static LevelDecisionResponse from(ApprovalLevelDecision decision) {
        ...
        return new LevelDecisionResponse(
                decision.getId(),
